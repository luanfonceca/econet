...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_timeline', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeline', null=True, to=orm['accounts.User'])),
        ))
        db.send_create_signal(u'app', ['Timeline'])


    def backwards(self, orm):
        # Deleting model 'Timeline'
        db.delete_table(u'app_timeline')
    ...
    models = {
        ...
        u'app.collectspot': {
            ...
            'local': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'app.timeline': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'timeline'", 'null': 'True', 'to': u"orm['accounts.User']"})
        },
        u'auth.group': {
